      ...
      <div style="padding: 16px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 12px; margin-bottom: 24px;">
          <div style="background: linear-gradient(135deg, #1a3a5e, #1a5e9e); border-radius: 16px; padding: 14px; color: white;">
            ...
            <div style="font-size: 11px; opacity: 0.7;">Total Students</div>
          ...
          <div style="background: linear-gradient(135deg, #2e5a3a, #1b5e20); border-radius: 16px; padding: 14px; color: white;">
            ...
            <div style="font-size: 11px; opacity: 0.7;">Total Teachers</div>
          </div>
          <div style="background: linear-gradient(135deg, #5a3a1a, #8a5a0a); border-radius: 16px; padding: 14px; color: white;">
            ...
            <div style="font-size: 11px; opacity: 0.7;">Currently Online</div>
          ...
          <div style="background: linear-gradient(135deg, #3a1a6e, #5e2a9e); border-radius: 16px; padding: 14px; color: white;">
            ...
            <div style="font-size: 11px; opacity: 0.7;">Attendance Rate (${thisMonth})</div>
          </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; margin-bottom: 20px;">
          <div style="background: rgba(255,255,255,0.06); border-radius: 12px; padding: 12px;">
            <div style="font-size: 12px; font-weight: 700; opacity: 0.7; margin-bottom: 6px;">👨‍🏫 Teacher Attendance</div>
            <div style="font-size: 24px; font-weight: 800;">${teacherAttRate}%</div>
            <div style="font-size: 10px; opacity: 0.5;">${thisMonth}</div>
          </div>
          <div style="background: rgba(255,255,255,0.06); border-radius: 12px; padding: 12px;">
            <div style="font-size: 12px; font-weight: 700; opacity: 0.7; margin-bottom: 6px;">📝 Homework Defaulters</div>
            <div style="font-size: 24px; font-weight: 800;">${uniqueDefaulters}</div>
            <div style="font-size: 10px; opacity: 0.5;">${totalDefaulters} total occurrences</div>
          </div>
          <div style="background: rgba(255,255,255,0.06); border-radius: 12px; padding: 12px;">
            <div style="font-size: 12px; font-weight: 700; opacity: 0.7; margin-bottom: 6px;">⚠️ Fee Defaulters</div>
            <div style="font-size: 24px; font-weight: 800;">${feeDefaulters}</div>
            <div style="font-size: 10px; opacity: 0.5;">students with dues</div>
          </div>
          <div style="background: rgba(255,255,255,0.06); border-radius: 12px; padding: 12px;">
            <div style="font-size: 12px; font-weight: 700; opacity: 0.7; margin-bottom: 6px;">⏳ Pending Approvals</div>
            <div style="font-size: 24px; font-weight: 800;">${pendingCount}</div>
            <div style="font-size: 10px; opacity: 0.5;">students waiting</div>
          </div>
        </div>
